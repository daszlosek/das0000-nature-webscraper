...
subjournal_html_parser <- function(subjournal,volume,issue,child_node) {
          tmp_html <- read_html(paste0("https://www.nature.com/",subjournal,"/volumes/",volume,"/issues/",issue))
          
          
          # parse html text
          tmp_html %>% html_node(paste0(".pb30:nth-child(",child_node,") a")) %>% html_text2()
}
...
nsmb %>% html_node(paste0(".pb30:nth-child(",9,") a")) %>% html_text()
...
nature_article_extractor <- function(volume,issue) {
           nsmb <- read_html(paste0("https://www.nature.com/,",subjournal,",/volumes/",volume,"/issues/",issue))
