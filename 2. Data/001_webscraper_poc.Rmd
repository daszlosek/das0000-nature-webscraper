...
# all_comb2 <- expand.grid(issue = 1:3, child_node = 1:2, subjournal = c("nsmb"),volume = 1:2, stringsAsFactors=FALSE)
# 
# 
...
# test <- cbind(all_comb, parse_title) 
# 
# test
# 
# typeof(test)
...
article_combination_list <- cmapply(issue = 1:3, child_node = 1:2, subjournal = c("leu"),volume = 1:2, FUN=nature_html_parser)  
